...
以下のキー位置はマウスレイヤー解除をトリガーしません：

| キー | 説明 |
|------|------|
| mkp MB1/MB2/MB3 | マウスボタン（左/右/中クリック） |
| msc SCRL_UP/DOWN | スクロールアップ/ダウン |
| mo 2 | SCROLLレイヤーへの一時切替 |
| Shiftキー（ホールド時） | Shift+クリックでテキスト選択可能 |

#### Shift+クリック対応
左Shiftキーは特殊な動作をします：
- **ホールド** → Shiftとして機能し、マウスレイヤーを維持（テキスト選択可能）
- **タップ** → マウスレイヤーを解除してキー入力
